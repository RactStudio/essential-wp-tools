    ...
    <div id="ewpt-page-main" class="wrap ewpt-page-main">
		...
		<div id="ewpt-page-body" class="ewpt-page-body">
			...
			<h2 class="nav-tab-wrapper">
				...
				<?php //<a href="#services" class="nav-tab">Services</a> ?>
			...
			<div id="roadmap" class="tab-content" style="display: none;">
				<div class="tab-pane">
			...
			**/
			...
			<div id="contact" class="tab-content" style="display: none;">
				<div class="tab-pane">
					<h3 class="ewpt-no-top-border">Contact Information</h3>
					...
					<div class="ewpt-form ewpt-border-radius-bottom-5px">
						<div class="ewpt-info-blue ewpt-info-border ewpt-info-full">
							...
							Email: bd.mhrubel@gmail.com<br/>
							WhatsApp: +8801734998405<br/>
							Website: <a target="_blank" href="http://mhr.ractstudio.com">mhr.ractstudio.com</a><br/>
							GitHub: <a target="_blank" href="http://github.com/RactStudio">github.com/RactStudio</a><br/>
							Facebook: <a target="_blank" href="http://facebook.com/bd.mhrubel">facebook.com/bd.mhrubel</a><br/>
							Twitter/X: <a target="_blank" href="http://x.com/bd_mhrubel">x.com/bd_mhrubel</a><br/>
							LinkedIn: <a target="_blank" href="http://linkedin.com/in/mhrubel">linkedin.com/in/mhrubel</a>
							</p>
