...
add_action( 'admin_menu', function () {
    $cached_icon = get_transient('ewpt_menu_icon_base64'); // Retrieve from cache
	
	 if ($cached_icon === false) {
        $response = wp_remote_get(EWPT_PLUGIN_URL . 'admin/assets/img/ewpt-icon-white.svg'); // ewpt-icon.svg ; ewpt-icon-black.svg
        if (is_wp_error($response)) {
            $base64_svg = ''; // Fallback empty base64 string for the icon
        } else {
            $base64_svg = wp_remote_retrieve_body($response);
            $base64_svg = base64_encode($base64_svg);
            set_transient('ewpt_menu_icon_base64', $base64_svg, DAY_IN_SECONDS); // Cache for a day
        }
    } else {
        $base64_svg = $cached_icon;
    }
	...
	add_menu_page(
		...
		'data:image/svg+xml;base64,' . $base64_svg, // Icon
		2  // The position
	);
});
...
function ewpt_essential_wp_tools_settings_page() {
	...
	// Active Modules
	$ewpt_active_modules = ewpt::ewpt_active_modules();
?>
	...
	<div id="ewpt-page-main" class="wrap ewpt-page-main">
		...
		<div id="ewpt-page-body" class="ewpt-page-body">
			...
			<h2 class="nav-tab-wrapper">
				<a href="#<?php echo sanitize_html_class($EWPT_MODULE_TAB_DEFAULT); ?>" class="nav-tab">Dashboard (<?php echo intval(count($ewpt_active_modules)); ?>)</a>
			...
			<form id="<?php echo sanitize_html_class(strtolower(EWPT_SHORT_SLUG)); ?>-form" name="<?php echo sanitize_html_class(strtolower(EWPT_SHORT_SLUG)); ?>-form" method="post" action="options.php">
				...
				<div id="<?php echo sanitize_html_class($EWPT_MODULE_TAB_DEFAULT); ?>" class="tab-content" style="display: none;">
					<div class="tab-pane">
						<h3 class="ewpt-no-top-border">Dashboard (<?php echo intval(count($ewpt_active_modules)); ?> Active Modules)</h3>
						
						<div class="ewpt-row ewpt-border-radius-bottom-5px ewpt-no-tab-target">
							<?php
				...
				<div id="modules-manager" class="tab-content" style="display: none;">
					<div class="tab-pane">
				...
				<div id="upcoming-modules" class="tab-content" style="display: none;">
					<div class="tab-pane">
				...
				<div id="about-ewpt" class="tab-content" style="display: none;">
					<div class="tab-pane">
			...
			<div id="modules-repository" class="tab-content" style="display: none;">
				<div class="tab-pane">
					...
					<table class="wp-list-table widefat striped ewpt-no-top-border ewpt-border-radius-bottom-5px">
						...
						<tbody>
							<tr valign="top">
								<td>1</td>
								<td>
									<a class="ewpt-module-name" target="_blank" href="https://github.com/RactStudio/ad-insert-hub/">Ad Insert Hub</a><br>
									&#x1f5cd; v1.0.0<br>
							...
							<tr valign="top">
								<td>2</td>
								<td>
									<a class="ewpt-module-name" target="_blank" href="https://github.com/RactStudio/email-manager-hub/">Email Manager Hub</a><br/>
									&#x1f5cd; v1.0.0 <br>
									by <a title="Author: Mahamudul Hasan Rubel" class="ewpt-module-author" target="_blank" href="https://mhr.ractstudio.com/">Mahamudul Hasan Rubel</a>
								</td>
								<td>
							...
							<tr valign="top">
								<td>3</td>
								<td>
									<a class="ewpt-module-name" target="_blank" href="https://github.com/RactStudio/essential-tools/">Essential Tools</a><br>
									&#x1f5cd; v1.0.0<br> 
							...
							<tr valign="top">
								<td>4</td>
								<td>
									<a class="ewpt-module-name" target="_blank" href="https://github.com/RactStudio/maintenance-mode/">Maintenance Mode</a><br/>
									&#x1f5cd; v1.0.0<br>
									by <a title="Author: RactStudio" class="ewpt-module-author" target="_blank" href="https://ractstudio.com/">RactStudio</a>
								</td>
								<td>
							...
							<tr valign="top">
								<td>5</td>
								<td>
									<a class="ewpt-module-name" target="_blank" href="https://github.com/RactStudio/sample-module/">Sample Module</a><br>
									&#x1f5cd; v0.1.0<br>
									by <a title="Author: RactStudio" class="ewpt-module-author" target="_blank" href="https://ractstudio.com/">RactStudio</a>
								</td>
								<td>
							...
							<tr valign="top">
								<td>6</td>
								<td>
									<a class="ewpt-module-name" target="_blank" href="https://github.com/RactStudio/social-share-hub/">Social Share Hub</a><br>
									&#x1f5cd; v1.0.0<br>
									by <a title="Author: Mahamudul Hasan Rubel" class="ewpt-module-author" target="_blank" href="https://mhr.ractstudio.com/">Mahamudul Hasan Rubel</a>
								</td>
								<td>
							...
							<tr valign="top">
								<td>7</td>
								<td>
									<a class="ewpt-module-name" target="_blank" href="https://github.com/RactStudio/system-info/">System Info</a><br>
									&#x1f5cd; v1.0.0<br>
									by <a title="Author: RactStudio" class="ewpt-module-author" target="_blank" href="https://ractstudio.com/">RactStudio</a>
								</td>
								<td>
			...
			<div id="modules-uploader" class="tab-content" style="display: none;">
				<div class="tab-pane">
		...
		<div id="ewpt-page-footer" class="ewpt-page-footer">
			...
			jQuery(document).ready(function($) {
				...
				$('#confirmDeleteModule').on('click', function() {
					...
					fetchWithRetry('<?php echo esc_url(admin_url('admin-ajax.php')); ?>', {
						method: 'POST',
						body: formData,
						cache: 'no-cache'
						...
						.catch(error => {
							showModal('saveModal', '<strong>Error during module deletion.</strong>', false);
							ewptMask.hide();
						})
						.finally(() => {
				...
				$('#confirmReplaceModule').on('click', function() {
					...
					fetchWithRetry('<?php echo esc_url(admin_url('admin-ajax.php')); ?>', {
						...
						.catch(error => {
							showModal('saveModal', '<strong>Error during module replacement.</strong>', false);
							ewptMask.hide();
						})
						.finally(() => {
							$allSubmitButtons.prop('disabled', false).val('Save Changes');
				...
				$('#activateModuleConfirm').on('click', function() {
					...
					fetchWithRetry('<?php echo esc_url(admin_url('admin-ajax.php')); ?>', {
						...
						.catch(error => {
							showModal('saveModal', '<strong>Error during module activation.</strong>', false);
							ewptMask.hide();
						})
						.finally(() => {
							$allSubmitButtons.prop('disabled', false).val('Save Changes');
				...
				function reloadPageContent(successMessage, modalClass) {
					fetch(window.location.href, {
						...
						.then(responseText => {
							...
							if (!newFormMain) {
								throw new Error('Failed to find the #ewpt-page-main element in the fetched content.');
							}
