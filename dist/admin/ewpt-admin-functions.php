<?php
// essential-wp-tools/admin/ewpt-admin-functions.php
...
class ewpt {
	...
	// Method to sanitize callbacks and update settings data (form submission)
	...
	// Method to register settings with various data types and optional custom sanitize callbacks and invalid data messages (FetchAPI)
    ...
    // Function to generate all active mdoules array
    public static function ewpt_active_modules() {
	...
	public static function enqueue_ewpt_admin_assets() {
		add_action('admin_enqueue_scripts', function (){
			// EWPT admin main css style (header)
			wp_register_style('ewpt-admin-style', EWPT_PLUGIN_URL . 'inc/css/ewpt-admin-style.min.css', array(), '1.0.0');
			wp_enqueue_style('ewpt-admin-style');
			// jQuery skeleton loader style (header)
			wp_register_style('ewpt-admin-skeleton-style', EWPT_PLUGIN_URL . 'lib/jquery-skeleton-loader/jquery.skeleton.min.css', array(), '1.0.0');
			wp_enqueue_style('ewpt-admin-skeleton-style');
			// jQuery skeleton loader script (footer)
			wp_register_script('ewpt-admin-skeleton-script', EWPT_PLUGIN_URL . 'lib/jquery-skeleton-loader/jquery.scheletrone.min.js', array('jquery'), '1.0.0', true);
			wp_enqueue_script('ewpt-admin-skeleton-script');
		});
	}
