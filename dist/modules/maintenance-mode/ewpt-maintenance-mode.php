...
add_action(
	'init',
	function () {
		ewpt::register_setting_data('ewpt_maintenance_mode_settings', 'ewpt_enable_maintenance_mode', 'boolean');
...
if (!function_exists('ewpt_maintenance_mode_settings_page_rsmhr')) {
function ewpt_maintenance_mode_settings_page_rsmhr() {
...
?>
	...
	<div class="wrap">
		...
		<h2 class="nav-tab-wrapper">
			...
			<a href="#mm-design" class="nav-tab">Page Design</a>
			<a href="#mm-seo" class="nav-tab">SEO</a>
			<?php
			$advanced_enable = get_option('ewpt_enable_maintenance_mode_advanced_enable', 0);
			if ( empty($advanced_enable) || $advanced_enable == 0 ) { ?>
			<a href="#mm-advanced" class="nav-tab">Advanced</a>
			<?php } ?>
			<?php
			...
			<a href="#mm-templates" class="nav-tab">Templates</a>
			<a href="#mm-countdown" class="nav-tab">Countdown</a>
			<a href="#mm-social-links" class="nav-tab">Social Links</a>
			<?php } ?>
		...
		<form id="<?php echo sanitize_html_class(strtolower(EWPT_SHORT_SLUG)); ?>-form" name="<?php echo sanitize_html_class(strtolower(EWPT_SHORT_SLUG)); ?>-form" method="post" action="options.php">
				...
				<div class="tab-pane">
					...
					<table class="form-table ewpt-form ewpt-form-border-bottom">
						<tr valign="top">
							...
							<td>
								<label>
									<input type="checkbox" name="ewpt_enable_maintenance_mode" value="1" <?php checked(get_option('ewpt_enable_maintenance_mode', 0)) ?> />
									Enable
								</label>
								<label>
							...
							<td>
								<div class='ewpt-info-red'>
									...
									Note: Caching plugins / CDN might interrupt the "Maintenance Mode" being enabled. Make sure to disable them.<br/>
								</div>
							</td>
						</tr>
			...
			<div id="mm-design" class="tab-content">
				<div class="tab-pane">
			...
			<div id="mm-seo" class="tab-content">
				<div class="tab-pane">
			...
			<div id="mm-advanced" class="tab-content">
				<div class="tab-pane">
			...
			<div id="mm-templates" class="tab-content">
				<div class="tab-pane">
					
					<h3 class="ewpt-no-top-border">Templates Settings</h3>
					<div class="ewpt-form ewpt-border-radius-bottom-5px">
						<div class="ewpt-info-green ewpt-info-border ewpt-info-full">
							<strong>Page Templates with various designs, customizations, light, dark, and colorful mode templates are coming very soon.</strong></br>
						</div>
					</div>
			...
			<div id="mm-countdown" class="tab-content">
				<div class="tab-pane">
					
					<h3 class="ewpt-no-top-border">Time Countdown Settings</h3>
					<div class="ewpt-form ewpt-border-radius-bottom-5px">
						<div class="ewpt-info-green ewpt-info-border ewpt-info-full">
							<strong>Time Countdown (days/hours/minutes/seconds) with various designs, customizations, light, dark and colorful mode templates are coming very soon.</strong></br>
						</div>
					</div>
			...
			<div id="mm-social-links" class="tab-content">
				<div class="tab-pane">
					
					<h3 class="ewpt-no-top-border">Social Share Links Settings</h3>
					<div class="ewpt-form ewpt-border-radius-bottom-5px">
						<div class="ewpt-info-green ewpt-info-border ewpt-info-full">
							<strong>Popular social share sites links with light, dark and colorful icon pack templates are coming very soon.</strong></br>
						</div>
					</div>
...
add_action(
	...
	function () {
		...
		if (isset($_GET['page']) && $_GET['page'] === 'ewpt-maintenance-mode') {
			...
			wp_register_script( 'mm-wp-color-picker-alpha', $color_picker_alpha_script, array( 'wp-color-picker' ), '3.0.3', true);
			wp_enqueue_script( 'mm-wp-color-picker-alpha' );
		}
	}
);

$mm_advanced_enable = get_option('ewpt_enable_maintenance_mode_advanced_enable', 0);
// If the advanced mode is disabled (do not enqueue)
if ( empty($mm_advanced_enable) || $mm_advanced_enable == 0 ) {
