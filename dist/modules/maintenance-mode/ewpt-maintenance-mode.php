	...
	<div id="ewpt-page-main" class="wrap ewpt-page-main">
		...
		<div id="ewpt-page-body" class="ewpt-page-body">
			...
			<form id="<?php echo sanitize_html_class(strtolower(EWPT_SHORT_SLUG)); ?>-form" name="<?php echo sanitize_html_class(strtolower(EWPT_SHORT_SLUG)); ?>-form" method="post" action="options.php">
				...
				<div id="mmhub-design" class="tab-content" style="display: none;">
					<div class="tab-pane">
				...
				<div id="mmhub-seo" class="tab-content" style="display: none;">
					<div class="tab-pane">
				...
				<div id="mmhub-advanced" class="tab-content" style="display: none;">
					<div class="tab-pane">
				...
				<div id="upcoming-features" class="tab-content" style="display: none;">
					<div class="tab-pane">
