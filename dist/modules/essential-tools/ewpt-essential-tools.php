	...
	<div id="ewpt-page-main" class="wrap ewpt-page-main">
		...
		<div id="ewpt-page-body" class="ewpt-page-body">
			...
			<form id="<?php echo sanitize_html_class(strtolower(EWPT_SHORT_SLUG)); ?>-form" name="<?php echo sanitize_html_class(strtolower(EWPT_SHORT_SLUG)); ?>-form" method="post" action="options.php">
				...
				<div id="general-tools" class="tab-content" style="display: none;">
					<div class="tab-pane">
				...
				<div id="posts-tools" class="tab-content" style="display: none;">
					<div class="tab-pane">
				...
				<div id="auto-excerpt" class="tab-content" style="display: none;">
					<div class="tab-pane">
				...
				<div id="posts-sort" class="tab-content" style="display: none;">
					<div class="tab-pane">
				...
				<div id="media-tools" class="tab-content" style="display: none;">
					<div class="tab-pane">
				...
				<div id="archives-tools" class="tab-content" style="display: none;">
					<div class="tab-pane">
				...
				<div id="search-tools" class="tab-content" style="display: none;">
					<div class="tab-pane">
				...
				<div id="users-tools" class="tab-content" style="display: none;">
					<div class="tab-pane">
				...
				<div id="login-tools" class="tab-content" style="display: none;">
					<div class="tab-pane">
				...
				<div id="rss-tools" class="tab-content" style="display: none;">
					<div class="tab-pane">
				...
				<div id="security-tools" class="tab-content" style="display: none;">
					<div class="tab-pane">
