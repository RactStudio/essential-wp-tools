...
if (!function_exists('ewpt_essential_tools_settings_page_rsmhr')) {
function ewpt_essential_tools_settings_page_rsmhr() {
				...
				<div class="tab-pane">
					...
					<table class="form-table ewpt-form ewpt-form-border-bottom ewpt-border-radius-bottom-5px">
						...
						<tr valign="top">
							...
							<td>
								<label>
									<textarea name="customize_wp_admin_footer_text" rows="6" cols="45"><?php echo esc_textarea(get_option('customize_wp_admin_footer_text', 'Thank you for creating with <a href="https://wordpress.org/" previewlistener="true">WordPress</a>.')); ?></textarea>
								</label>
							</td>
							<td>
								<div class='ewpt-info-blue'>
					...
					<table class="form-table ewpt-form ewpt-form-border-bottom ewpt-border-radius-bottom-5px">
						...
						<tr valign="top">
							...
							<td>
								...
								<label>
									<input type="number" name="custom_post_rev_number" min="2" max="300" value="<?php echo esc_attr(get_option('custom_post_rev_number', 20)); ?>" />
								</label>
							</td>
							<td>
								<div class='ewpt-info-blue'>
									How many WP Post Revisions you would like to keep, min=2 and max=300, default=20
								</div>
							</td>
						</tr>
						...
						<tr valign="top">
							...
							<td>
								...
								<label>
									<input type="number" name="custom_min_word_count" min="2" max="200000" value="<?php echo esc_attr(get_option('custom_min_word_count', 100)); ?>" />
									Words
								</label>
							</td>
							<td>
								<div class='ewpt-info-blue'>
									Won't be able to publish wp post unless it is admin user, min=2 and max=200000, default=100
								</div>
							</td>
						</tr>
						...
						<tr valign="top">
							...
							<td>
								...
								<label>
									<input type="number" name="custom_autosave_interval" value="<?php echo esc_attr(get_option('custom_autosave_interval', 5)); ?>" />
									Minutes
								</label>
							</td>
							<td>
								<div class='ewpt-info-blue'>
									Set a custom WP Post Autosave Interval (in minutes), default=5
								</div>
							</td>
						</tr>
				...
				<div class="tab-pane">
					...
					<table class="form-table ewpt-form ewpt-form-border-bottom ewpt-border-radius-bottom-5px">
						...
						<tr valign="top">
							...
							<td>
								<div class='ewpt-info-blue'>
									...
									Note: If already have Excerpt texts, then will use that. Also, would execute below options.
								</div>
							</td>
						</tr>
						...
						<tr valign="top">
							...
							<td>
								<label>
									<input type="number" name="affix_auto_excerpt_words_count_length" min="0" max="500" value="<?php echo esc_attr(get_option('affix_auto_excerpt_words_count_length', 35)); ?>" />
								</label>
							</td>
							<td>
								<div class='ewpt-info-blue'>
									Add custom excerpt words length, min=0 and max=500, default=35
								</div>
							</td>
						</tr>
						...
						<tr valign="top">
							...
							<td>
								<div class='ewpt-info-blue'>
									Add a link on the Read More Text. (Note: "Excerpt Read More" option must be enabled)
								</div>
							</td>
						</tr>
				...
				<div class="tab-pane">
					...
					<table class="form-table ewpt-form ewpt-form-border-bottom ewpt-border-radius-bottom-5px">
						...
						<tr valign="top">
							...
							<td>
								<label>
									<input type="number" name="custom_oembed_width" value="<?php echo esc_attr(get_option('custom_oembed_width', 400)); ?>" />
									Width
								</label>
								<label>
									<input type="number" name="custom_oembed_height" value="<?php echo esc_attr(get_option('custom_oembed_height', 280)); ?>" />
									Height
								</label>
							</td>
							<td>
						...
						<tr valign="top">
							...
							<td>
								<div class='ewpt-info-red'>
									...
									Note: May conflict with 'Auto Post Redirect' feature of various plugin. Example: Rank Math SEO -> Auto Post Redirect
								</div>
							</td>
						</tr>
				...
				<div class="tab-pane">
					...
					<table class="form-table ewpt-form ewpt-form-border-bottom ewpt-border-radius-bottom-5px">
						...
						<tr valign="top">
							...
							<td>
								<label>
									<input type="number" name="rss_feeds_posts_delay_minutes" value="<?php echo esc_attr(get_option( 'rss_feeds_posts_delay_minutes', 10 )) ?>" />
									Minutes Delay
								</label>
								<div class='ewpt-info-red'>
									EXPERIMENTAL
						...
						<tr valign="top" class="ewpt-no-bottom-border">
							<th scope="row">Exclude Categories from Feeds</th>
							<td>
								<label>
						...
						<tr valign="top" class="ewpt-no-bottom-border">
							...
							<td>
								<div class='ewpt-info-red'>
									...
									Note: 'All Users' and 'Only Logged-in Users' option also disables AJAX and Cron REST API calls.<br/>
									This might cause issues for some themes and plugins.
								</div>
							</td>
						</tr>
						<tr valign="top">
						...
						<tr valign="top">
							...
							<td>
								<div class='ewpt-info-red'>
									...
									Note: Redirect happens only if your website (server) has SSL certificate properly installed.
								</div>
							</td>
						</tr>
