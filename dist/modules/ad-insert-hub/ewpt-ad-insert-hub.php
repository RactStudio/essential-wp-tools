...
if (!function_exists('ewpt_ad_insert_hub_settings_page_rsmhr')) {
function ewpt_ad_insert_hub_settings_page_rsmhr() {
	...
	$ewpt_ads_i = get_option('enable_total_ads_counter', 10);
				...
				<div class="tab-pane">
					...
					<table class="form-table ewpt-form ewpt-form-border-bottom">
						<tr valign="top">
							...
							<td>
								<label>
									<input type="checkbox" name="ewpt_disable_all_ad_insert_hub_options" value="1" <?php checked(get_option('ewpt_disable_all_ad_insert_hub_options'), 1); ?> />
									Disable
								</label>
							</td>
							<td>
					...
					<table class="form-table ewpt-form ewpt-no-bottom-border">
						...
						<tr valign="top">
							...
							<td>
								<input type="number" name="enable_total_ads_counter" min="1" max="100" value="<?php echo esc_attr(get_option('enable_total_ads_counter', 10)); ?>" />
							</td>
							<td>
								<div class='ewpt-info-blue'>
									Decreasing the ad slot's does not clear saved data or alter the enabled status of ad slots.
								</div>
							</td>
						</tr>
						...
						<tr valign="top">
							<th scope="row">Enable All Ads Shortcodes</th>
							<td>
								<label>
					...
					<div class="tab-pane">
						...
						<table class="form-table ewpt-form ewpt-no-bottom-border">
							...
							<tr valign="top">
								...
								<td>
									<label>
										<input type="checkbox" name="enable_ads_<?php echo intval($i); ?>_code" value="1" <?php checked(get_option("enable_ads_{$i}_code"), 1); ?> />
										Enable
									</label>
								</td>
							</tr>
						...
						<table class="form-table ewpt-form ewpt-no-bottom-border">
							...
							<?php if ( !empty($ewpt_post_types) && (get_option('enable_ewpt_ads_custom_post_types', 0) == 1)) {  ?>
								...
								<?php foreach ($ewpt_post_types  as $post_type) { ?>
										<td>
											<label>
												<input type="checkbox" name="ads_<?php echo intval($i); ?>_place_<?php echo sanitize_html_class($post_type); ?>" value="1" <?php checked(get_option("ads_{$i}_place_{$post_type}"), 1); ?> />
